...
class _BiometricAuthApiCodec extends StandardMessageCodec {
  const _BiometricAuthApiCodec();
  @override
...
class BiometricAuthApi {
  ...
  BiometricAuthApi({BinaryMessenger? binaryMessenger})
      : _binaryMessenger = binaryMessenger;
  final BinaryMessenger? _binaryMessenger;

  static const MessageCodec<Object?> codec = _BiometricAuthApiCodec();

  Future<AuthResult> authenticate() async {
    const String channelName = 'dev.flutter.pigeon.auth.BiometricAuthApi.authenticate';
